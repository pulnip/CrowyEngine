...
if(BREW_RESULT EQUAL 0 AND EXISTS "${BREW_LLVM_PREFIX}")
    ...
    set(CMAKE_EXE_LINKER_FLAGS_INIT    "-L${BREW_LLVM_PREFIX}/lib/c++")
    set(CMAKE_SHARED_LINKER_FLAGS_INIT "-L${BREW_LLVM_PREFIX}/lib/c++")
    set(CMAKE_MODULE_LINKER_FLAGS_INIT "-L${BREW_LLVM_PREFIX}/lib/c++")
endif()