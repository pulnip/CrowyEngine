...
namespace Crowy
{
    ...
    D3D12_RESOURCE_STATES convert(RHIResourceState state){
        ...
        case RHIResourceState::NonFragmentShaderResource: return D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE;
        case RHIResourceState::FragmentShaderResource:    return D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE;
        ...
        case RHIResourceState::Predication:               return D3D12_RESOURCE_STATE_PREDICATION;
        default:
            std::unreachable();
        }
    }
